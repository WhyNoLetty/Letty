...
(function (factory) {
  if(typeof module === "object" && typeof module.exports === "object") {
    ...
    AmsifySuggestags = function(selector) {
        ...
        this.classes       = {
          sTagsArea     : '.amsify-suggestags-area text-dark',
          inputArea     : '.amsify-suggestags-input-area text-dark',
          inputAreaDef  : '.amsify-suggestags-input-area-default text-dark',
          focus         : '.amsify-focus',
          sTagsInput    : '.amsify-suggestags-input',
          listArea      : '.amsify-suggestags-list text-dark',
          list          : '.amsify-list',
